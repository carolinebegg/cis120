...
let test () : bool = 
  ...
  truncate 1 q; 
  to_list q = [1]
;; run_test "truncate after first element" test

let test () : bool = 
  let q = from_list [1; 2; 3] in
  truncate 2 q;
  to_list q = [1; 2]
;; run_test "truncate after second element" test

let test () : bool = 
  let q = from_list [1; 2; 3] in
  truncate 3 q;
  to_list q = [1; 2; 3]
;; run_test "truncate after third (last) element" test

let test () : bool = 
  let q = from_list [1; 2; 3] in
  truncate 4 q;
  to_list q = [1; 2; 3]
;; run_test "element not in list" test
...
let test () : bool =
  ...
  delete 1 q;
  to_list q = [2; 3]
;; run_test "delete first element, appears once" test

let test () : bool =
  let q = from_list [1; 2; 1] in 
  delete 1 q;
  to_list q = [2]
;; run_test "delete first and last element, appears twice" test

let test () : bool =
  let q = from_list [1; 1; 1] in 
  delete 1 q;
  to_list q = []
;; run_test "delete all elements" test
